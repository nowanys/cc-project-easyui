package com.cjhme.system.main.interceptor.mybatis.bean;
 ...
 * @author
 * @version 1.0
 * @created Sep 14, 2014 9:45:09 AM
 */
public class DataPaging<E> {
	...
	public static DataPaging<Object> pageUtil(String page, String pageRows) {
		...
		// 每页显示条数
		int rows = Integer.parseInt((pageRows == null || pageRows.equals("0")) ? "15" : pageRows);
