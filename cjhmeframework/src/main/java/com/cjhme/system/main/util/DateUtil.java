 ...
 * @author cjh
 * @version 1.0
 * @created Dec 2, 2013 3:19:13 PM
 */
public class DateUtil {
	/**
	 * Function: getNowDate 静态方讲学 Description: 获得当前日期,以yyyyMMdd形式表示 Calls:
	...
	/**
	 * Function: getNowTime 静�?�方�? Description: 取当前时�?,以HHmmss形式表示 Calls:
	 * Called By: Table Accessed: Table Updated:
	 * 
	 * @return String 当前时间
	 */
	...
	/**
	 * Function: getDateAfter Description: 得到给出日期之后n个月的日�? , 日期以yyyyMMdd形式表示
	 * Calls: Called By: Table Accessed: Table Updated:
	 * 
	 * @param String
	 *            当前日期
	 * @param int
	 ...
	 * (�?,按一�?360�?,�?�?30天计�?) Calls: Called By: Table Accessed: Table
	 * Updated:
	 * 
	 * @return int 天数
	 */
