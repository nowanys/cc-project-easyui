  ...
  <head>
	...
	<script type="text/javascript">
	  ...
	  function serializeForm(){
	    var fields = ['accessUrl','accessUrlName','status'];
  ...
  <body class="body-scroll">
     <table style="width:100%;margin: 10px" cellspacing="0" cellpadding="3">
	        ...
	        <td class="table-style-0" style="width:20%;">
	          ...
	          <td style="width:80%">
	            <input type="text" id="accessUrlName"   class="easyui-validatebox input-border01"  required="required" validType="checkTrimLength[50,25]">
	        ...
	        <tr>
	          ...
	          <td style="width:80%">
	            <textarea id="accessUrl" class="easyui-validatebox textarea-border01" style="height:50px" required="required" validType="length[1,200]"></textarea>
	            <span style="color:red">*</span>
	          </td>
	        </tr>
	        <tr>
