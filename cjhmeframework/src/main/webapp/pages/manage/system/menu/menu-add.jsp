...
<html>
  <head>
	...
	<script type="text/javascript">
	  ...
	  function serializeForm(){
	    var fields = ['menuCode','menuName','iconCls','accessUrl','parentMenuId'];
  ...
  <body class="body-scroll">
     <input type="hidden" id="parentMenuId" value="${requestScope.menuId}"/>
     ...
     <table style="width:100%;margin: 10px" cellspacing="0" cellpadding="3">
            <tr>
	          ...
	          <td style="width:80%">
	            <input type="text"  id="menuCode"  class="easyui-validatebox input-border01"  required="required" validType="length[1,30]">
	        ...
	        <tr>
	          ...
	          <td style="width:80%">
	            <input type="text" id="menuName"  class="easyui-validatebox input-border01"  required="required" validType="checkTrimLength[30,15]">
	            <span style="color:red">*</span>
	          </td>
	        </tr>
	        <tr>
	          ...
	          <td style="width:80%">
	            <textarea id="accessUrl" class="easyui-validatebox textarea-border01" style="height:50px" validType="length[0,200]"></textarea>
	          </td>
	        </tr>
	        <tr>
	          <td class="table-style-0" style="width:20%">
