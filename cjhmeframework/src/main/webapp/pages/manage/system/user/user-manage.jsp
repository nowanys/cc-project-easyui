...
<html>
  <head>
	...
	<script type="text/javascript" charset="utf-8" src="pages/manage/system/user/js/user-manage.js"></script>
    ...
    <script type="text/javascript">
	  $(function(){
			...
			$('#infos').datagrid({
		            ...
		            striped: true, 
		            collapsible:true, 
		            url:mUrl.queryUserByConditionPaging,
		            sortName: 'userId', 
		            sortOrder: 'desc', 
		            remoteSort: true, 
		            idField:'userId', 
     ...
     <div data-options="region:'north',border:false" style="padding:5px">
		<form id="queryForm" name ="queryForm">  
			<table>  
			    ...
			    <tr>
			      <td width="50px" style="text-align:right">姓名：</td>
			      <td width="170px" >
			      ...
			      <td width="300px">
			          <a href="javascript:void(0)" title="查询" onclick="queryUserByCondition()" class="easyui-linkbutton" style="margin-left:20px" iconCls="icon-search">查询</a>
