  ...
  <body class="body-scroll">
     <table style="width:100%;margin: 10px" cellspacing="0" cellpadding="3">
	       <tr>
	          ...
	          <td style="width:90%">
	             <input type="text"  id="noticeTitle"   class="easyui-validatebox input-border01" style="width:550px"  required="required"  validType="length[0,100]">
	          </td>
	        </tr>
	        <tr>
	          <td class="table-style-0" style="width:10%">
	        ...
	        <tr>
	          ...
	          <td style="width:90%">
	            <input id="cutoffDate" type="text" class="easyui-datebox  input-border01" data-options="editable:false" />
	          </td>
	        </tr>
	        <tr>
	          <td class="table-style-0" style="width:10%">
