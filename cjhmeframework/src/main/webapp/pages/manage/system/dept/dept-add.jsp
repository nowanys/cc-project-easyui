...
<html>
  <head>
	...
	<script type="text/javascript">
	  ...
	  function serializeForm(){
	    var fields = ['parentDeptId','deptCode','deptName','deptSortName','deptLevel','deptDescript','deptLeaderId','deptTel','deptAddr','iconCls','smsSwitch','emailSwitch'];
  ...
  <body class="body-scroll">
     <input type="hidden" id="parentDeptId" value="${requestScope.deptId}"/>
     ...
     <table style="width:100%;margin: 10px" cellspacing="0" cellpadding="3">
	        <tr>
	          ...
	          <td style="width:80%">
	            <input type="text"  id="deptCode"  class="easyui-validatebox input-border01"  required="required" validType="length[1,30]">
	        ...
	        <tr>
	          ...
	          <td style="width:80%">
	            <input type="text" id="deptName"  class="easyui-validatebox input-border01"  required="required" validType="checkTrimLength[40,20]">
	            <span style="color:red">*</span>
	          </td>
	        </tr>
	        <tr>
	          ...
	          <td style="width:80%">
	            <input type="text" id="deptSortName"  class="easyui-validatebox input-border01"  validType="checkTrimLength[30,15]">
	          </td>
	        </tr>
	        <tr>
	          <td class="table-style-0" style="width:20%;">
	          ...
	          <td style="width:80%">
	            <input  type="text" id="deptLevel" class="easyui-numberspinner easyui-validatebox input-border01" data-options="required:true,precision:0,min:1,max:10">
	            <span style="color:red">*</span>
	          </td>
	        </tr>
	        <tr>
	          ...
	          <td style="width:80%">
	            <textarea id="deptDescript" class="easyui-validatebox textarea-border01" validType="length[0,500]"></textarea>
	          </td>
	        </tr>
	        <tr>
	          <td class="table-style-0" style="width:20%;">
	          ...
	          <td style="width:80%">
	            <input type="text" id="deptLeader" class="easyui-validatebox input-border03" required="required" readonly="readonly">
	        ...
	        <tr>
	          ...
	          <td style="width:80%">
	            <input type="text" id="deptTel"  class="easyui-validatebox input-border01"  validType="telephone">
	          </td>
	        </tr>
	        <tr>
	          <td class="table-style-0" style="width:20%">
	          ...
	          <td style="width:80%">
	            <textarea id="deptAddr" class="easyui-validatebox textarea-border01" style="height:50px" validType="length[0,200]"></textarea>
	          </td>
	        </tr>
	        <tr>
	          <td class="table-style-0" style="width:20%">
	          ...
	          <td style="width:80%">
	            ...
	            <input type="text" id="iconCls" value="icon-dept" class="easyui-validatebox input-border04"  required="required" readonly="readonly">
	            <a href="javascript:void(0);"  class="easyui-linkbutton" icon="icon-select" title="选择图标" onclick="iconSelect()"></a>
	            <span style="color:red">*</span>
	            <script type="text/javascript">
	              var iconImg = 'icon-dept';
